...
import ModalListDefunt from "../Modals/ModalListDefunts";
import ModalAddDefunt from "../Modals/ModalAddDefunt";
...
export default function ListDefuntsSmall() {
    ...
    <div className="w-full mb-8">
      <div className="flex flex-col mb-6">
        <div className="flex my-4">
          <h1 className="font-bold mr-2">Liste des défunts</h1>
          <i
          ...
          ></i>
          {openModalAdd && <ModalAddDefunt onClose={setOpenModalAdd} />}
        </div>
        ...
        <table className="table table-pin-rows">
          ...
          <tbody>
            {selectedPersonBySerach &&
              selectedPersonBySerach
                .filter((person) =>
                  person.lastName.toLowerCase().startsWith("a")
                )
                .map((person) => (
                  <tr key={person.id}>
          ...
          <tbody>
            {selectedPersonBySerach &&
              selectedPersonBySerach
                .filter((person) =>
                  person.lastName.toLowerCase().startsWith("b")
                )
                .map((person) => (
                  <tr key={person.id}>
                    <td>{person.lastName}</td>
          ...
          <tbody>
            {selectedPersonBySerach &&
              selectedPersonBySerach
                .filter((person) =>
                  person.lastName.toLowerCase().startsWith("c")
                )
                .map((person) => (
                  <tr key={person.id}>
                    <td>{person.lastName}</td>
          ...
          <tbody>
            {selectedPersonBySerach &&
              selectedPersonBySerach
                .filter((person) =>
                  person.lastName.toLowerCase().startsWith("d")
                )
                .map((person) => (
                  <tr key={person.id}>
                    <td>{person.lastName}</td>
          ...
          <tbody>
            {selectedPersonBySerach &&
              selectedPersonBySerach
                .filter((person) =>
                  person.lastName.toLowerCase().startsWith("e")
                )
                .map((person) => (
                  <tr key={person.id}>
                    <td>{person.lastName}</td>
          ...
          <tbody>
            {selectedPersonBySerach &&
              selectedPersonBySerach
                .filter((person) =>
                  person.lastName.toLowerCase().startsWith("f")
                )
                .map((person) => (
                  <tr key={person.id}>
                    <td>{person.lastName}</td>
          ...
          <tbody>
            {selectedPersonBySerach &&
              selectedPersonBySerach
                .filter((person) =>
                  person.lastName.toLowerCase().startsWith("g")
                )
                .map((person) => (
                  <tr key={person.id}>
                    <td>{person.lastName}</td>
          ...
          <tbody>
            {selectedPersonBySerach &&
              selectedPersonBySerach
                .filter((person) =>
                  person.lastName.toLowerCase().startsWith("h")
                )
                .map((person) => (
                  <tr key={person.id}>
                    <td>{person.lastName}</td>
          ...
          <tbody>
            {selectedPersonBySerach &&
              selectedPersonBySerach
                .filter((person) =>
                  person.lastName.toLowerCase().startsWith("i")
                )
                .map((person) => (
                  <tr key={person.id}>
                    <td>{person.lastName}</td>
          ...
          <tbody>
            {selectedPersonBySerach &&
              selectedPersonBySerach
                .filter((person) =>
                  person.lastName.toLowerCase().startsWith("j")
                )
                .map((person) => (
                  <tr key={person.id}>
                    <td>{person.lastName}</td>
          ...
          <tbody>
            {selectedPersonBySerach &&
              selectedPersonBySerach
                .filter((person) =>
                  person.lastName.toLowerCase().startsWith("k")
                )
                .map((person) => (
                  <tr key={person.id}>
                    <td>{person.lastName}</td>
          ...
          <tbody>
            {selectedPersonBySerach &&
              selectedPersonBySerach
                .filter((person) =>
                  person.lastName.toLowerCase().startsWith("l")
                )
                .map((person) => (
                  <tr key={person.id}>
                    <td>{person.lastName}</td>
          ...
          <tbody>
            {selectedPersonBySerach &&
              selectedPersonBySerach
                .filter((person) =>
                  person.lastName.toLowerCase().startsWith("m")
                )
                .map((person) => (
                  <tr key={person.id}>
                    <td>{person.lastName}</td>
          ...
          <tbody>
            {selectedPersonBySerach &&
              selectedPersonBySerach
                .filter((person) =>
                  person.lastName.toLowerCase().startsWith("n")
                )
                .map((person) => (
                  <tr key={person.id}>
                    <td>{person.lastName}</td>
          ...
          <tbody>
            {selectedPersonBySerach &&
              selectedPersonBySerach
                .filter((person) =>
                  person.lastName.toLowerCase().startsWith("o")
                )
                .map((person) => (
                  <tr key={person.id}>
                    <td>{person.lastName}</td>
          ...
          <tbody>
            {selectedPersonBySerach &&
              selectedPersonBySerach
                .filter((person) =>
                  person.lastName.toLowerCase().startsWith("p")
                )
                .map((person) => (
                  <tr key={person.id}>
                    <td>{person.lastName}</td>
          ...
          <tbody>
            {selectedPersonBySerach &&
              selectedPersonBySerach
                .filter((person) =>
                  person.lastName.toLowerCase().startsWith("q")
                )
                .map((person) => (
                  <tr key={person.id}>
                    <td>{person.lastName}</td>
          ...
          <tbody>
            {selectedPersonBySerach &&
              selectedPersonBySerach
                .filter((person) =>
                  person.lastName.toLowerCase().startsWith("r")
                )
                .map((person) => (
                  <tr key={person.id}>
                    <td>{person.lastName}</td>
          ...
          <tbody>
            {selectedPersonBySerach &&
              selectedPersonBySerach
                .filter((person) =>
                  person.lastName.toLowerCase().startsWith("s")
                )
                .map((person) => (
                  <tr key={person.id}>
                    <td>{person.lastName}</td>
          ...
          <tbody>
            {selectedPersonBySerach &&
              selectedPersonBySerach
                .filter((person) =>
                  person.lastName.toLowerCase().startsWith("t")
                )
                .map((person) => (
                  <tr key={person.id}>
                    <td>{person.lastName}</td>
          ...
          <tbody>
            {selectedPersonBySerach &&
              selectedPersonBySerach
                .filter((person) =>
                  person.lastName.toLowerCase().startsWith("u")
                )
                .map((person) => (
                  <tr key={person.id}>
                    <td>{person.lastName}</td>
          ...
          <tbody>
            {selectedPersonBySerach &&
              selectedPersonBySerach
                .filter((person) =>
                  person.lastName.toLowerCase().startsWith("v")
                )
                .map((person) => (
                  <tr key={person.id}>
                    <td>{person.lastName}</td>
          ...
          <tbody>
            {selectedPersonBySerach &&
              selectedPersonBySerach
                .filter((person) =>
                  person.lastName.toLowerCase().startsWith("w")
                )
                .map((person) => (
                  <tr key={person.id}>
                    <td>{person.lastName}</td>
          ...
          <tbody>
            {selectedPersonBySerach &&
              selectedPersonBySerach
                .filter((person) =>
                  person.lastName.toLowerCase().startsWith("x")
                )
                .map((person) => (
                  <tr key={person.id}>
                    <td>{person.lastName}</td>
          ...
          <tbody>
            {selectedPersonBySerach &&
              selectedPersonBySerach
                .filter((person) =>
                  person.lastName.toLowerCase().startsWith("y")
                )
                .map((person) => (
                  <tr key={person.id}>
                    <td>{person.lastName}</td>
          ...
          <tbody>
            {selectedPersonBySerach &&
              selectedPersonBySerach
                .filter((person) =>
                  person.lastName.toLowerCase().startsWith("z")
                )
                .map((person) => (
                  <tr key={person.id}>
                    <td>{person.lastName}</td>
