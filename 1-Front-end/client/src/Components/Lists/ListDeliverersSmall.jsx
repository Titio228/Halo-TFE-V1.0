...
import ModalListDeliverers from "../Modals/ModalListDeliverers";
import ModalAddDeliverer from "../Modals/ModalAddDeliverer";
...
export default function ListDeliverersSmall() {
    ...
    <div className="w-full overflow-x-auto h-96 mb-8">
      <div className="flex flex-col mb-6">
        <div className="flex my-4">
          <h1 className="font-bold mr-2">Liste des livreurs</h1>
          <i
          ...
          ></i>
          {openModalAdd && <ModalAddDeliverer onClose={setOpenModalAdd} />}
        </div>
      ...
      <table className="table table-pin-rows">
        {data.filter((person) => person.lastName.startsWith("A")).length >
          0 && (
          <thead>
            <tr>
              <th>A</th>
        ...
        {selectedPersonBySerach.filter((person) => person.lastName.startsWith("B")).length >
          0 && (
          <thead>
            <tr>
              <th>B</th>
        ...
        {selectedPersonBySerach.filter((person) => person.lastName.startsWith("C")).length >
          0 && (
          <thead>
            <tr>
              <th>C</th>
        ...
        {selectedPersonBySerach.filter((person) => person.lastName.startsWith("D")).length >
          0 && (
          <thead>
            <tr>
              <th>D</th>
        ...
        {selectedPersonBySerach.filter((person) => person.lastName.startsWith("E")).length >
          0 && (
          <thead>
            <tr>
              <th>E</th>
        ...
        {selectedPersonBySerach.filter((person) => person.lastName.startsWith("F")).length >
          0 && (
          <thead>
            <tr>
              <th>F</th>
        ...
        {selectedPersonBySerach.filter((person) => person.lastName.startsWith("G")).length >
          0 && (
          <thead>
            <tr>
              <th>G</th>
        ...
        {selectedPersonBySerach.filter((person) => person.lastName.startsWith("H")).length >
          0 && (
          <thead>
            <tr>
              <th>H</th>
        ...
        {selectedPersonBySerach.filter((person) => person.lastName.startsWith("I")).length >
          0 && (
          <thead>
            <tr>
              <th>I</th>
        ...
        {selectedPersonBySerach.filter((person) => person.lastName.startsWith("J")).length >
          0 && (
          <thead>
            <tr>
              <th>J</th>
        ...
        {selectedPersonBySerach.filter((person) => person.lastName.startsWith("K")).length >
          0 && (
          <thead>
            <tr>
              <th>K</th>
        ...
        {selectedPersonBySerach.filter((person) => person.lastName.startsWith("L")).length >
          0 && (
          <thead>
            <tr>
              <th>L</th>
        ...
        {selectedPersonBySerach.filter((person) => person.lastName.startsWith("M")).length >
          0 && (
          <thead>
            <tr>
              <th>M</th>
        ...
        {selectedPersonBySerach.filter((person) => person.lastName.startsWith("N")).length >
          0 && (
          <thead>
            <tr>
              <th>N</th>
        ...
        {selectedPersonBySerach.filter((person) => person.lastName.startsWith("O")).length >
          0 && (
          <thead>
            <tr>
              <th>O</th>
        ...
        {selectedPersonBySerach.filter((person) => person.lastName.startsWith("P")).length >
          0 && (
          <thead>
            <tr>
              <th>P</th>
        ...
        {selectedPersonBySerach.filter((person) => person.lastName.startsWith("Q")).length >
          0 && (
          <thead>
            <tr>
              <th>Q</th>
        ...
        {selectedPersonBySerach.filter((person) => person.lastName.startsWith("R")).length >
          0 && (
          <thead>
            <tr>
              <th>R</th>
        ...
        {selectedPersonBySerach.filter((person) => person.lastName.startsWith("S")).length >
          0 && (
          <thead>
            <tr>
              <th>S</th>
        ...
        {selectedPersonBySerach.filter((person) => person.lastName.startsWith("T")).length >
          0 && (
          <thead>
            <tr>
              <th>T</th>
        ...
        {selectedPersonBySerach.filter((person) => person.lastName.startsWith("U")).length >
          0 && (
          <thead>
            <tr>
              <th>U</th>
        ...
        {selectedPersonBySerach.filter((person) => person.lastName.startsWith("V")).length >
          0 && (
          <thead>
            <tr>
              <th>V</th>
        ...
        {selectedPersonBySerach.filter((person) => person.lastName.startsWith("W")).length >
          0 && (
          <thead>
            <tr>
              <th>W</th>
        ...
        {selectedPersonBySerach.filter((person) => person.lastName.startsWith("X")).length >
          0 && (
          <thead>
            <tr>
              <th>X</th>
        ...
        {selectedPersonBySerach.filter((person) => person.lastName.startsWith("Y")).length >
          0 && (
          <thead>
            <tr>
              <th>Y</th>
        ...
        {selectedPersonBySerach.filter((person) => person.lastName.startsWith("Z")).length >
          0 && (
          <thead>
            <tr>
              <th>Z</th>
